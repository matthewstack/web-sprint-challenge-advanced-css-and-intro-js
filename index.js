...
console.log('task1b', artists[2].name);
...
artists.splice(9,1, {'name':'Vincent Van Gogh'})
...
function getArtistByIndex(array, num1) {
  return `the artist at index ${num1} is ${array[num1].name}`
}
